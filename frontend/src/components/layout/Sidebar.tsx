...
const NAV_GROUPS: NavGroup[] = [
  {
    label: 'Demo',
    items: [
      { to: '/demo', icon: MessageSquare, label: 'Option A vs B' },
    ],
  },
  {
    label: 'Architecture',
  ...
  return (
    <aside className="flex flex-col w-60 min-h-screen bg-surface-100 border-r border-border shrink-0">
      ...
      <div className="flex items-center gap-3 px-5 h-16 border-b border-border">
        ...
        <div>
          <div className="text-sm font-semibold text-gray-100">Capital Markets</div>
          <div className="text-[10px] text-gray-500 uppercase tracking-wider">Teams Agent</div>
        </div>
      </div>
